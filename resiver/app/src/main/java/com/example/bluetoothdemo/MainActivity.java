...
//                        System.out.println(bluetoothDevice.getAddress());
                        DeviceInformation deviceInformation = new DeviceInformation(bluetoothDevice.getName(),
...
//                    //保存设备的信息
//                    DeviceInformation deviceInformation = new DeviceInformation(device.,device.getAddress());
                }
            }
        };
        //注册广播接收者
